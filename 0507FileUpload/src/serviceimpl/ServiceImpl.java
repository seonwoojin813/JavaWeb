...
public Map<String, Object> fileUpload(HttpServletRequest request) {
	...
	try {
		...
		//form-data; name="file"; filename="jar.zip"
		
		//form-data; name="file"; filename="jar.zip" 이걸 복사해서 String j = "" 괄호 안에 붙여넣으면 밑에 처럼 \\가 붙어
		//String j = "form-data; name=\"file\"; filename=\"jar.zip\"";
		...
		//실제 업로드 될 파일 이름 만들기 -  파일 이름 중복을 방지하기위해서
		//확장자 만들기
		...
		while(true) {
			...
			//중복검사
			File f = new File("/Users/a503_08/Documents/" + 
			uploadfilename);
